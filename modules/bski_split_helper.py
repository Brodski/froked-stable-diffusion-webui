...
def do_column_thing(processed, columnz_width, outpath_grids, grid_format):
        rowz = math.ceil( len(processed.images) / columnz_width)
        print("bski - DOING COLUMN THING")
        grid = images.image_grid(processed.images, batch_size=1, rows=rowz, columnz=columnz_width) # batch_zize is relevant here, just filler b/c thats how they wrote their code
        ...
        if columnz_width > 0:
            ...
            # aux_processed_res_images = processed.images 
