...
def txt2img_create_processing(id_task: str, request: gr.Request, prompt: str, negative_prompt: str, prompt_styles, n_iter: int, batch_size: int, cfg_scale: float, height: int, width: int, enable_hr: bool, denoising_strength: float, hr_scale: float, hr_upscaler: str, hr_second_pass_steps: int, hr_resize_x: int, hr_resize_y: int, hr_checkpoint_name: str, hr_sampler_name: str, hr_scheduler: str, hr_prompt: str, hr_negative_prompt, override_settings_texts, multiple_run_count, columnz_width, *args, force_enable_hr=False):
...
def txt2img(id_task: str, request: gr.Request, *args):
    # NOTE
    # NOTE
    # called from "ui.py", ~line 427, "txt2img_args"
    print("GOT SOMETHING FROM CLICK!")
    # print(args)
    multiple_run_count = args[20] 
    print("multiple_run_count=", multiple_run_count)
